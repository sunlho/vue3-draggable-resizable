...
import { PositionStore, Position, UpdatePosition, GetPositionStore, MatchedLine, SetMatchedLine } from "./types"
        ...
        ...matchedCols.value.map((item) => {
          return h("div", {
            style: {
              ...
              top: "0",
              left: item + "px",
              borderLeft: `1px dashed ${props.referenceLineColor}`,
              position: "absolute",
            },
          })
        }),
        ...matchedRows.value.map((item) => {
          return h("div", {
            style: {
              ...
              left: "0",
              top: item + "px",
              borderTop: `1px dashed ${props.referenceLineColor}`,
              position: "absolute",
            },
          })
        }),
